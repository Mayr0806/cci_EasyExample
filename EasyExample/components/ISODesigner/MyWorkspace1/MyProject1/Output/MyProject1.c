...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_1), TYPEID_MACRO, WORD(16),
		...
		CMD_CONTROL_AUDIO_DEVICE, 2, WORD(440), WORD(100), WORD(100)
	ID(Macro_2), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(Seite_2), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(200), WORD(200)
	ID(Macro_3), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(Seite_2), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 1, WORD(440), WORD(100), WORD(150)
	ID(Macro_4), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_Home), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 6, WORD(440), WORD(100), WORD(100)
	ID(Macro_5), TYPEID_MACRO, WORD(16),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(Seite3), 0xFF, 0xFF, 0xFF,
		CMD_CONTROL_AUDIO_DEVICE, 6, WORD(440), WORD(100), WORD(100)
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 7, 0, 
		...
		XYREF(Button_6005, 402, 66),
	ID(Seite_2), TYPEID_DATAMASK, COLOR_YELLOW, ID(ID_NULL), 2, 0, 
		XYREF(S2, 192, 73),
		XYREF(Button_S_3, 197, 192),
	ID(Seite3), TYPEID_DATAMASK, COLOR_GREEN, ID(ID_NULL), 2, 0, 
		XYREF(Button_S3, 56, 59),
		XYREF(Button_6007, 53, 249),
	...
	ID(Button_S_3), TYPEID_BUTTON, WORD(96), WORD(83), 48, 9, 1, 0, 1, 1, 
		XYREF(OutputString_S_3, -4, 20),
	...
	ID(S2), TYPEID_BUTTON, WORD(96), WORD(80), 39, 9, 1, 0, 1, 1, 
		XYREF(OutputString_S2, -4, 26),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_6005), TYPEID_BUTTON, WORD(73), WORD(74), 39, 9, 1, 0, 1, 1, 
		XYREF(OutputString_S1, -4, 23),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_S3), TYPEID_BUTTON, WORD(108), WORD(88), 14, 220, 1, 0, 1, 0, 
		XYREF(OutputString_S3, -4, 30),
	ID(Button_6007), TYPEID_BUTTON, WORD(114), WORD(102), 14, 222, 1, 0, 1, 0, 
		XYREF(OutputString_S4, -4, 37),
	...
	ID(OutputString_S2), TYPEID_OUTSTR, WORD(96), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_S_3), TYPEID_OUTSTR, WORD(81), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '_', '3', ' ', 0,
	ID(OutputString_S1), TYPEID_OUTSTR, WORD(73), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '1', ' ', ' ', 0,
	ID(OutputString_S3), TYPEID_OUTSTR, WORD(108), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '3', ' ', ' ', 1,
		MACRO(EV_CHGVAL, Macro_3),
	ID(OutputString_S4), TYPEID_OUTSTR, WORD(114), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '4', ' ', ' ', 1,
		MACRO(EV_CHGVAL, Macro_4),
	...
	ID(OutputString_11016), TYPEID_OUTSTR, WORD(123), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'B', 'u', 't', 't', 'o', 'n', 0,
	ID(OutputString_11017), TYPEID_OUTSTR, WORD(97), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'B', 'u', 't', 't', 'o', 'n', 0,
