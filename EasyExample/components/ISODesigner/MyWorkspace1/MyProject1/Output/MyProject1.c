...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 7, 0, 
		...
		XYREF(Meter_Tageszaehler, 400, 137),
		XYREF(Container_Tageszaehler, 202, 5),
		XYREF(OutputString_ZielErreicht, 500, 150),
		XYREF(Button_PlusPlus, 398, 312),
		XYREF(Button_MinusMinus, 399, 398),
		XYREF(Container_3003, 2, 10),
	...
	ID(Container_3002), TYPEID_CONTAINER, WORD(191), WORD(470), 0, 1, 0, 
		XYREF(Container_Gesamtzaehler, 0, 0),
	ID(Container_3003), TYPEID_CONTAINER, WORD(191), WORD(470), 0, 1, 0, 
		XYREF(Container_Gesamtzaehler, 0, 0),
	...
	ID(Button_PlusPlus), TYPEID_BUTTON, WORD(80), WORD(80), 69, 144, 1, 0, 1, 0, 
	...
	ID(Button_MinusMinus), TYPEID_BUTTON, WORD(80), WORD(80), 41, 144, 1, 0, 1, 0, 
